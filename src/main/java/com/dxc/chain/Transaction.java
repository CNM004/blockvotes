...
public class Transaction {
	...
	public boolean processTransaction() {
		...
		for (TransactionInput i : inputs) {
			i.UTXO = HomeController.UTXOs.get(i.transactionOutputId);
		}

		// check if transaction is valid:
		if (getInputsValue() < HomeController.minimumTransaction) {
		...
		for (TransactionOutput o : outputs) {
			HomeController.UTXOs.put(o.id, o);
		}
		...
		for (TransactionInput i : inputs) {
			...
			HomeController.UTXOs.remove(i.UTXO.id);
		}
	...
	public String toString() {
		return this.transactionId+" "+this.sender+" "+this.reciepient+" "+this.value;
	}
}
